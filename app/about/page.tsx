          ...
          <div className="container-px relative grid items-center gap-8 pb-10 lg:grid-cols-2 lg:gap-6 lg:pb-12">
            <div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <a href="/bookconsultation" className="inline-flex items-center gap-2 rounded-xl bg-gold-gradient px-6 py-3.5 text-sm font-bold uppercase tracking-wider text-night shadow-gold-btn transition-transform hover:-translate-y-0.5">
                  Book Consultation →
                </a>
        ...
        <section className="py-12 lg:py-16">
          <div className="container-px">
            ...
            <div className="mt-10 text-center">
              <a href="/bookconsultation" className="inline-flex items-center gap-2 rounded-xl bg-gold-gradient px-8 py-4 text-sm font-bold uppercase tracking-wider text-night shadow-gold-btn transition-transform hover:-translate-y-0.5">
                Book a Consultation →
              </a>
            </div>
          </div>
