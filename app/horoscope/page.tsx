        ...
        <section className="container-px">
          <div className="grid items-center gap-8 rounded-3xl border border-gold-500/15 bg-white/70 p-6 lg:grid-cols-2 lg:p-8">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1b1033] via-[#2a1747] to-[#0e0822] p-8 text-center">
              ...
              <a href="/bookconsultation" className="relative mt-6 inline-block rounded-xl bg-gold-gradient px-6 py-3 text-sm font-bold text-night shadow-gold-btn transition-transform hover:-translate-y-0.5">
          ...
          <div className="container-px grid gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-6 rounded-3xl border border-gold-500/15 bg-gradient-to-r from-gold-50 to-[#FBF1D9] p-6">
                ...
                <a href="/bookconsultation" className="mt-4 inline-block rounded-xl bg-gold-gradient px-5 py-2.5 text-sm font-bold text-night shadow-gold-btn transition-transform hover:-translate-y-0.5">
                  Get Started →
                </a>
              </div>
            </div>
